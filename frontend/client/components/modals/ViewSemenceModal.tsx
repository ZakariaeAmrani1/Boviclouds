      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <div className="flex items-center gap-2 mt-2">
            {getStatusBadge()}
            <span className="text-sm text-gray-500">ID: {semence.id}</span>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
                ...
                <span className="text-gray-900">{semence.race_taureau}</span>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
                ...
                <span className="text-gray-900">{semence.createdBy}</span>
              </div>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
            ...
            <div className="space-y-2 text-sm text-blue-800">
              ...
              <p>
                • Numéro d'identification du taureau:{" "}
                <strong>{semence.num_taureau}</strong>
              </p>
              <p>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-md">
            ...
            <div className="space-y-2 text-sm text-green-800">
              <p>• Identificateur conforme au format SEM + 6 chiffres</p>
              <p>
                • Numéro du taureau conforme au format 2 lettres + 8 chiffres
              </p>
              <p>
                • Semence disponible pour utilisation en insémination
                artificielle
              </p>
              <p>• Données vérifiées et validées</p>
            </div>
          </div>
        </div>
