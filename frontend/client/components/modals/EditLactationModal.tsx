...
const EditLactationModal: React.FC<EditLactationModalProps> = ({
  ...
  const { identifications, loading: identificationsLoading } =
    useIdentifications();
  ...
  const handleFormChange = (field: keyof FormData, value: string | number) => {
    ...
    if (field === "lait_kg" || field === "kg_mg") {
      ...
      if (milkKg > 0 && mgKg >= 0) {
        ...
        setFormData((prev) => ({
          ...prev,
          pct_mg: Number(calculatedMgPct.toFixed(2)),
        }));
      }
    }
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleFormChange("sujet_id", value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleFormChange("date_velage", e.target.value)
                    }
                    className={
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.n_lactation ? "border-red-500" : ""
                    }
                    disabled={loading}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleFormChange("controleur_laitier_id", value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleFormChange("kg_mg", parseFloat(e.target.value) || 0)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.pct_proteine ? "border-red-500" : ""
                    }
                    disabled={loading}
                  />
